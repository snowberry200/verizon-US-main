          ...
          children: [
            Link(
              ...
              builder: (context, followLink) => TextButton(
                ...
                child: LayOutWidget.isMobile(context)
                    ? Text(
                        'Support',
        ...
        SizedBox(
          child: Row(
            ...
            children: <Widget>[
              IconButton(
                onPressed: () {},
                icon: LayOutWidget.isMobile(context)
                    ? Icon(size: 22, Icons.search, color: CupertinoColors.white)
              ...
              IconButton(
                ...
                icon: LayOutWidget.isMobile(context)
                    ...
                    : Icon(Icons.shopping_bag, color: CupertinoColors.white),
              ),
              IconButton(
                onPressed: () {},
                icon: LayOutWidget.isMobile(context)
                    ? Icon(size: 22, Icons.menu, color: CupertinoColors.white)
